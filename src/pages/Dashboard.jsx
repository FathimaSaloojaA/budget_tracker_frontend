...
export default function Dashboard({ openExpense, setOpenExpense }) {
  ...
  const isEmpty = categories.length === 0 && budgets.length === 0;
    ...
    <div className="dashboard-container">
      ...
      {isEmpty ? (
        <div className="empty-state">
          <p>Please go to <strong>Settings</strong> and add categories and set budgets to see your reports.Click On <strong>+Add Expense</strong> to record your expenses </p>
        </div>
      ) : (
        <>
